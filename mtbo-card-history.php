...
<html>
    ...
    <body>
        <?php
            ...
            // PROCESSING //
            ////////////////
            $resultx = $databaseSI->query("SELECT stamp_card_id, stamp_readout_datetime FROM stamps WHERE stamp_control_code = 0 ORDER BY id_stamp DESC;");

            while ($read_card_id = $resultx->fetch_object()) {
